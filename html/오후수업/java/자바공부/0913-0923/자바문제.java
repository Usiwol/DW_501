...
public class 자바문제 {
	...
	public static void main(String[] args) {
		 ...
		 * 정담) Kim은 배열 1번 째에 있으므로 "Kim은 1번에 있습니다." 정답입니다.
		 * hint) 오늘 배운 equals와 for문을 이용해서 풀 것!
		 */
		//방법 1.
		for(int i=0; i<name.length; i++) {
			boolean isCheck = name[i].equals("Kim");	
			//System.out.println(isCheck);
			//isCheck == true 라고 쓰는거 추천하지 않는다.
			if(isCheck) {
		...
		//for(int i=1; i<3; i++) = for(int i=1; i<=2; i++)
		for(int i=1; i<3; i++) {
			array[i] = "****";
