...
public class order_list {
	...
	public order_list() {}
	public order_list(String name, String an_order, int price, String memo) { //seq, complete가 빠진 생산자 
		this.food_name=name;
		this.an_order=an_order;
		this.price=price;
		this.memo=memo;
	}
	public order_list(int seq, String name, String an_order, 
			int price, int complete, String memo) {
		this.seq=seq;
		this.food_name=name;
		this.an_order=an_order;
		this.price=price;
